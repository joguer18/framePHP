...
<head>
	...
	<meta content="" name="author" />
     <!--[if IE]>
        ...
        <![endif]-->
    <!-- GLOBAL STYLES -->
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/plugins/bootstrap/css/bootstrap.css" />
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/css/main.css" />
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/css/theme.css" />
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/css/MoneAdmin.css" />
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/plugins/Font-Awesome/css/font-awesome.css" />
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/DataTables-1.10.9/media/css/jquery.dataTables.min.css" />
    <!--END GLOBAL STYLES -->

    <!-- PAGE LEVEL STYLES -->
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/css/layout2.css"  />
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/plugins/flot/examples/examples.css"  />
    <link rel="stylesheet" href="<?php echo BASE_URL?>public/assets/plugins/timeline/timeline.css" />
    ...
    <!-- GLOBAL SCRIPTS -->
    <script src="<?php echo BASE_URL?>public/assets/plugins/jquery-2.0.3.min.js"></script>
    <script src="<?php echo BASE_URL?>public/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <script src="<?php echo BASE_URL?>public/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    <script src="<?php echo BASE_URL?>public/DataTables-1.10.9/media/js/jquery.dataTables.min.js"></script>
    <!-- END GLOBAL SCRIPTS -->

    <!-- PAGE LEVEL SCRIPTS -->
  <!--   <script src="<?php echo BASE_URL?>public/assets/plugins/flot/jquery.flot.js"></script>
    <script src="<?php echo BASE_URL?>public/assets/plugins/flot/jquery.flot.resize.js"></script>
    ...
    <script src="<?php echo BASE_URL?>public/assets/js/for_index.js"></script>
   --> 
       ...
       <div id="left" >
            <div class="media user-media well-small">
                <a class="user-link" href="#">
                    <img class="media-object img-thumbnail user-img" alt="User Picture" src="<?php echo BASE_URL?>public/assets/img/user.gif" />
                </a>
                <br />
